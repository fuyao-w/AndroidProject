...
/**
 * Created by 扶摇 on 2017/7/17.
 */

public class WatetWaveView extends View{
    ...
    WatetWaveView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    WatetWaveView(Context context) {
        super(context);
        init();
    }

    private void init() {
        setWaveInfo(60f, 1f, 2f, 15f, getResources().getColor(R.color.yellow));
    }
